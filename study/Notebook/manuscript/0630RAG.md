...
```python
# 此案例用于展示使用LangChain集成的huggingface的能力，调用嵌入模型，将文本内容转化为高维度的向量表示
...
print(f"输出的类型为：{type(model_output)}",end = "\n===================================================\n")
print(f"输出的长度为：{len(model_output)}",end = "\n===================================================\n")
print(f"输出的内容为：{model_output}",end = "\n===================================================\n")# 此案例用于展示使用LangChain集成的huggingface的能力，调用嵌入模型，将文本内容转化为高维度的向量表示
from langchain_huggingface import HuggingFaceEmbeddings
